                    ...
                    <form id="residuosForm" method="POST" action="{{route('admin.hallazgos.update',$muestreo->id_muestreo)}}">
                        ...
                        <div class="row centrarh ">
                            <div class="col-10 ">
                                ...
                                <div class="col-md-2">
                                    <input class="inputC form-control " type="number" name="cantidadesE[{{$hallazgo->id_hallazgo}}] " value="{{$hallazgo->cantidad}}" min="0" onchange="updateTotals()" required>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="row mb-3 " style="border-top: 1px solid">
                                    ...
                                    <label class=" form-control" id="totalC">0</label>
                                    </div>
                                    <div class="col-md-2 mt-3">
                                ...
                                <div class="">
                                    <button type="button" class="btn btn-dark" id="addMore" style="width: 200px" >Agregar más</button>
