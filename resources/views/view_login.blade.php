                      ...
                      <div class="col-lg-12  " >
                          <div class="card-body p-md-4 mx-md-4 ">
                              <div class="text-center">
                                  <img src="{{ asset('images/Logo-ResiPlay.png') }}" style="width: 200px;" alt="logo">
                              ...
                              @endif 
                                  ...
                                  <div class="text-center pt-1 mb-3 pb-1">
                                      <input type="submit" id="navbutton2" class=" btn-blue btn-largo  mb-3" name="accion" value="ingresar">
